                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="<?= $car->iamge ?>">
                                                <img src="<?= $car->iamge ?>" alt="product side">
                                            </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><?= $car->title ?></h1><!-- End .product-title -->
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="<?= $car->image ?>" alt="Product image" class="product-image">
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <h4 class="product-title"><a href="product.html"><?= $car->title ?></a></h4><!-- End .product-title -->
                </div><!-- End .col-6 -->
