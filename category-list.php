<?php
    ...
    $stmCat = $conn->prepare($sql_category);
    $stm->execute();
    $stmCat->execute();
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-3">
                                            <figure class="product-media">
                                                ...
                                                <a href="<?php echo "product-detail-view.php?id=$product->id" ?>">
                                                    <img src="<?= $product->image ?>" onerror="this.src='https://via.placeholder.com/200'" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="product-body product-action-inner">
                                                ...
                                                <h3 class="product-title"><a href="<?php echo "product-detail-view.php?id=$product->id" ?>"><?= $product->title ?></a></h3><!-- End .product-title -->
